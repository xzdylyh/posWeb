...
consumeData = [{"phoneOrCard":"1282511874548311","desc":u"积分消费","tcTotalFee":1,"tcStoredPay":1,"credit":1,"dualCode":'000000'}]
chargeDealData=[{"tcTotalFee":1,"desc":u"储值卡消费","phoneOrCard":"1282511874548311","dualCode":"000000"}]
custCouponData = [{"tcTotalFee":1,"desc":u"券消费","phoneOrCard":"1282511874548311","dualCode":'000000'}]
cardData = [{"PhoneNo":phone,"desc":u"实体卡开卡",'username':'yhleng','birthday':'1985-03-21','password':'000000'}]
cardBindData = [{"PhoneNo": phone,"desc":u"绑卡正常流程"}]
